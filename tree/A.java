...
public class A{
    ...
    public static class tPair{
        ...
        boolean rigtDone = false;

        tpair( Node node, boolean selfDone, boolean leftDone, boolean rigtDone){
            this.node = node;
            this.selfDone = selfDone;
            this.leftDone = leftDone;
            this.rigtDone = rightDone;
        }
    }

    public static void traversal( Node node ){ // post
